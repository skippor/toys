...
void Predict()
{
	...
	for(int i=0;i<TEST_SIZE;i++)
    {
        ...
        if(Sign(h)==1) shares[TRAINED_SIZE+i]=1;
        else shares[TRAINED_SIZE+i]=0;
...
void GetPocketW()
{
	...
	float h=0;
 	int iterations=100,mistake,newmistake,index;
	srand(time(0));
